...
namespace ARL
{
    public class ZkemClient : IZKEM
    {
        ...
        public bool UploadPicture(int dwMachineNumber, string FileName)
        {
            throw new NotImplementedException();
        }
        ...
        public bool UploadTheme(int dwMachineNumber, string FileName)
        {
            throw new NotImplementedException();
        }
        ...
        public bool GetCapturePhotos(int dwMachineNumber, string FilePath, ref string pFilePath)
        {
            throw new NotImplementedException();
        }

        public bool GetBlacklistPhotos(int dwMachineNumber, string FilePath, ref string pFilePath)
        {
            throw new NotImplementedException();
        }

        public bool GetUserPhotos(int dwMachineNumber, string FilePath, ref string pFilePath)
        {
            throw new NotImplementedException();
        }

        public bool SetGroupTimeZone(int dwMachineNumber, int GID, string timezone, string VerifyStyle)
        {
            throw new NotImplementedException();
        }

        public bool GetGroupTimeZone(int dwMachineNumber, int GID, ref string timezone, ref string VerifyStyle)
        {
            throw new NotImplementedException();
        }

        public bool TurnAlarmOff(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }

        public bool GetHolidayParam(int dwMachineNumber, int HolidayID, ref int TimeZoneID, ref int startmonth, ref int startday, ref int EndMonth, ref int EndDay)
        {
            throw new NotImplementedException();
        }

        public bool SetHolidayParam(int dwMachineNumber, int HolidayID, int TimeZoneID, int startmonth, int startday, int EndMonth, int EndDay)
        {
            throw new NotImplementedException();
        }

        public bool DeleteHolidayParam(int dwMachineNumber, int HolidayID)
        {
            throw new NotImplementedException();
        }

        public bool GetGroupHolidayValid(int dwMachineNumber, int groupID, ref int valid)
        {
            throw new NotImplementedException();
        }

        public bool SetGroupHolidayValid(int dwMachineNumber, int groupID, int valid)
        {
            throw new NotImplementedException();
        }

        public bool ReadAllOfflineDoorEventData(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }

        public bool GetOfflineDoorEventData(int dwMachineNumber, ref int eType, ref string Time)
        {
            throw new NotImplementedException();
        }

        public bool ClearOfflineDoorEvent(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }

        public bool ReadAllErrorCardData(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }

        public bool GetErrorCardData(int dwMachineNumber, ref int Card, ref string Time)
        {
            throw new NotImplementedException();
        }

        public bool ClearErrorCard(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }
        ...
        public bool DelUserOnTime(int dwMachineNumber, int dwEnrollNumber, int Year, int Month, int Day, int Hour, int Minute, int Second)
        {
            throw new NotImplementedException();
        }

        public bool ScheduleBell(int dwMachineNumber, int Index, int Enable, int Year, int Month, int Day, int Hour, int Minute, int Second, int Volce, int Vol, int Times)
        {
            throw new NotImplementedException();
        }

        public bool IsCalendar(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }

        public bool DelCapturePics(int captureFlag, string PIN)
        {
            throw new NotImplementedException();
        }

        public bool SetEveryWeekTimeZone(int dwMachineNumber, int nWeek, string timezone, string VerifyStyle)
        {
            throw new NotImplementedException();
        }

        public bool GetEveryWeekTimeZone(int dwMachineNumber, int nWeek, ref string timezone, ref string VerifyStyle)
        {
            throw new NotImplementedException();
        }

        public bool ReadAllOpenCloseDoorTime(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }

        public bool GetOpenCloseDoorTime(int dwMachineNumber, ref int UserID, ref string OpenDoorTime, ref string CloseDoorTime)
        {
            throw new NotImplementedException();
        }

        public bool ClearOpenCloseDoorTimeLog(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }

        public bool GetUserHolidayTZStr(int dwMachineNumber, int UserID, ref string TZs)
        {
            throw new NotImplementedException();
        }

        public bool SetUserHolidayTZStr(int dwMachineNumber, int UserID, string TZs)
        {
            throw new NotImplementedException();
        }

        public bool SetUserAPBFO(int dwMachineNumber, int dwEnrollNumber, int valid)
        {
            throw new NotImplementedException();
        }

        public bool GetUserAPBFO(int dwMachineNumber, int dwEnrollNumber, out int valid)
        {
            throw new NotImplementedException();
        }

        public bool DelUserAPBFO(int dwMachineNumber, int dwEnrollNumber)
        {
            throw new NotImplementedException();
        }
