using ARL.DataSetTableAdapters;
using System;
...
namespace ARL
{
    public class BLLClass
    {
        ...
        #region ============ Access Control Data Information ============
        internal string AllowedMailList(int part, string xmlString)
        {
            string msg = "";
            try
            {
        ...
        internal DataTable GetTodaymealList()
        {
            try
            {
                DataTable dt = new DataTable();
                TblCafeteriaDetailsTableAdapter adp = new TblCafeteriaDetailsTableAdapter();
                return dt = adp.GetTodayMealData();
            }
            catch { return new DataTable(); }
        }
        internal DataTable GetMealStatus(string strCardNo)
        {
            try
            {
                SprGetMealStatusTableAdapter adp = new SprGetMealStatusTableAdapter();
                return adp.GetMealStatus(strCardNo);
            }
            catch { return new DataTable(); }
        }
        internal DataTable GetEnrollByCode(string strCardNo)
        {
            try
            {
                EmployeeTableAdapter adp = new EmployeeTableAdapter();
                return adp.GetEnrollByCode(strCardNo);
            }
            catch { return new DataTable(); }
        }
        #endregion
        ...
        internal void UpdateNews(string strNews, int intActionBy)
        {
